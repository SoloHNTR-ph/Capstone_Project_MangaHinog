...
<section class="mx-20 my-10">
  ...
  <section class="mx-20">
    <div class="p-4 mb-4">
      ...
      <form id="reply-form-{{ $comment->id }}" action="/threads/{{ $thread->id }}/comments" method="POST" class="hidden w-full items-center">
        @csrf
        <div class="flex">
          <input type="hidden" name="parent_id" value="{{ $comment->id }}">
        <textarea name="content" placeholder="Reply to this comment..." class="w-full h-12 rounded "></textarea>
        <button type="submit" class=""><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" style="fill: rgba(0, 0, 0, 1);transform: ;msFilter:;"><path d="m21.426 11.095-17-8A1 1 0 0 0 3.03 4.242l1.212 4.849L12 12l-7.758 2.909-1.212 4.849a.998.998 0 0 0 1.396 1.147l17-8a1 1 0 0 0 0-1.81z"></path></svg></button>
        </div>
      </form>
    </div>
    @if ($comment->replies)
